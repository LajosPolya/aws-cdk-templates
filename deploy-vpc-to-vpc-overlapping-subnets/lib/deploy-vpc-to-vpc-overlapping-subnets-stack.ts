...
export interface DeployVpcToVpcOverlappingSubnetsStackProps extends cdk.StackProps {
  scope: string;
}

export class DeployVpcToVpcOverlappingSubnetsStack extends cdk.Stack {
  constructor(
    scope: Construct,
    id: string,
    props: DeployVpcToVpcOverlappingSubnetsStackProps,
  ) {
