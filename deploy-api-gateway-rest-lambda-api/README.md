...
This deploys an API Gateway REST API backed by Lambda. The API can be accessed by its URL which is exported by the CDK and therefore printed to the CLI when the app is deployed.
