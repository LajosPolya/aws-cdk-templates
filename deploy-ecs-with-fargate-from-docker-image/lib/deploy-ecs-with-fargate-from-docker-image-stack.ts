...
export class DeployEcsWithFargateFromDockerImageStack extends cdk.Stack {
  constructor(
    ...
    const cluster = new cdk.aws_ecs.Cluster(this, "cluster", {
      clusterName: `ecsFargateFromDockerImage-${props.scope}`,
      vpc: vpc,
    ...
    fargateTaskDef.addContainer("apiContainer", {
      ...
      logging: cdk.aws_ecs.LogDrivers.awsLogs({
        ...
        logGroup: new cdk.aws_logs.LogGroup(this, "logGroup", {
          logGroupName: `/ecs-with-fargate-api-from-docker-image/${props.scope}`,
    ...
    new cdk.aws_ecs.FargateService(this, "fargateService", {
      ...
      cluster: cluster,
      desiredCount: 1,
      serviceName: `fargateFromDockerImage-${props.scope}`,
